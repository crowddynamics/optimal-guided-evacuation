...
class Field(FieldBase):
    ...
    *curves* and *surfaces*, which correspond to shapely objects
    ...
    @staticmethod
    def _samples(spawn, obstacles, seed, radius=0.3):
    ...
    def sample_spawn(self, seed: int, spawn_index: int, radius: float = 0.3):
        """Generator for sampling points inside spawn without overlapping with
        obstacles"""
        return self._samples(self.spawns[spawn_index], self.obstacles, seed, radius)
