...
from simple_scenario import SimpleScenarioFloor, SimpleScenarioFloorField


# Import Finlandia Hall floor field
field = SimpleScenarioFloorField()
...
agents = np.load('agents_initialization_simple.npy')
...
print(cells)
# Loop through all the feasible cells and check if 6 guides can be positioned to them.
