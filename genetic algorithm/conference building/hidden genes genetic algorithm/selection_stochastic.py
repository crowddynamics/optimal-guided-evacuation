...
elitism_pr = [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]
...
exits7 = exits7[0::samples]
cells7 = cells7[0::samples]
tags7 = np.loadtxt("{}{}{}".format('tags7_', generation, '.txt'), dtype=int)
tags7 = tags7[0::samples]
if generation > 0:
...
exits8 = exits8[0::samples]
cells8 = cells8[0::samples]
tags8 = np.loadtxt("{}{}{}".format('tags8_', generation, '.txt'), dtype=int)
tags8 = tags8[0::samples]
if generation > 0:
...
exits9 = exits9[0::samples]
cells9 = cells9[0::samples]
tags9 = np.loadtxt("{}{}{}".format('tags9_', generation, '.txt'), dtype=int)
tags9 = tags9[0::samples]
if generation > 0:
...
exits10 = exits10[0::samples]
cells10 = cells10[0::samples]
tags10 = np.loadtxt("{}{}{}".format('tags10_', generation, '.txt'), dtype=int)
tags10 = tags10[0::samples]
if generation > 0:
