...
from finlandia_talo_ga_stochastic import FinlandiaTalo2ndFloor
...
if __name__ == '__main__':
    ...
    if n_guides == 1:
        ...
        run([[exits[0], cells[0]], [exits[1], cells[1]], [exits[2], cells[2]], [exits[3], cells[3]], [exits[4], cells[4]], [exits[5], cells[5]], [exits[6], cells[6]]], 7, seed)
    elif n_guides == 8:
        run([[exits[0], cells[0]], [exits[1], cells[1]], [exits[2], cells[2]], [exits[3], cells[3]], [exits[4], cells[4]], [exits[5], cells[5]], [exits[6], cells[6]], [exits[7], cells[7]]], 8, seed)
    elif n_guides == 9:
        run([[exits[0], cells[0]], [exits[1], cells[1]], [exits[2], cells[2]], [exits[3], cells[3]], [exits[4], cells[4]], [exits[5], cells[5]], [exits[6], cells[6]], [exits[7], cells[7]], [exits[8], cells[8]]], 9, seed)
    elif n_guides == 10:
        run([[exits[0], cells[0]], [exits[1], cells[1]], [exits[2], cells[2]], [exits[3], cells[3]], [exits[4], cells[4]], [exits[5], cells[5]], [exits[6], cells[6]], [exits[7], cells[7]], [exits[8], cells[8]], [exits[9], cells[9]]], 10, seed)
