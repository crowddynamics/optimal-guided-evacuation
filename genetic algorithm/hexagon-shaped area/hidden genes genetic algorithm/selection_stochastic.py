...
elitism_pr = [0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]
...
if generation >= 1:
    ...
    if generation >= len(elitism_pr):
        sorted_indices_parents = sorted_indices_parents[0:population]
    else:
...
for i in range(population):
    selected[i] = help_indices[sorted_indices[i]]
...
#print(selected)
# Randomize the selected individuals list (now its an ascending list)
#print(selected)
...
for i in range(population):
    #print(selected[i])
    #print(sample_positions[selected[i]])
