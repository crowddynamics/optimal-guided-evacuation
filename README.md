...
Research code and data (for data click on DOI identifier) used in von Schantz & Ehtamo. Minimizing the evacuation time of a crowd from a complex building using rescue guides. <em>arXiv:2007.00509 [physics.soc-ph]</em>. 2020. (submitted manuscript). 
